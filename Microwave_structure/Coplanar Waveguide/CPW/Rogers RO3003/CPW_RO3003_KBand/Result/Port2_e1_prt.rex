...
<MetaResultFile creator="FE Port mode solver" version="20170330">
  ...
  <SimulationProperties dB_Amplitude="20" encoded_unit="&amp;U:V^1.:m^-1" fieldname="&lt;name missing&gt;" fieldtype="E-Field" frequency="25"/>
  <MetaGeometryFile filename="" lod="1"/>
  <ResultGroups num_steps="1">
    <Frame index="0" characteristic="25">
      <FieldResultFile filename="Port2_e1_prt.sct" meshname="Port^Mesh^2_1.slm" type="sct"/>
    </Frame>
  </ResultGroups>
  ...
  <PlotSettings Clipping="Always on" Plot="1" ignore_symmetry="0" deformation="0">
    <Plane normal="-0 1 0" distance="6.150000095367"/>
  </PlotSettings>
  <Source type="SOLVER"/>
  <Units>
